...
<div style="max-width:800px;margin:0 auto;">
    <h1 style="font-size:2rem;font-weight:700;color:#003a8c;margin-bottom:0.5rem;">Tambah Item Inventaris</h1>
    <p style="color:#6b7280;margin-bottom:1.5rem;">Tambahkan aset atau barang inventaris gereja</p>
    
    <div style="background:#fff;border-radius:12px;padding:32px;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        <form method="post" action="{{ route('admin.inventaris_aset.store') }}">
            @csrf
