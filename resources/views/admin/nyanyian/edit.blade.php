...
@section('content')
    <div class="dashboard-module">
        <div style="margin-bottom:24px;">
            <h2 style="margin:0 0 8px 0;">Edit Nyanyian</h2>
        ...
        <form method="post" action="{{ route('admin.nyanyian.update', $nyanyian) }}">
            @csrf @method('PUT')
            ...
            <div class="box" style="margin-bottom:20px;">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" 
                           name="nomor_lagu" 
                           value="{{ old('nomor_lagu', $nyanyian->nomor_lagu) }}" 
                ...
                <div class="mb-2">
                    ...
                    <input type="text" 
                           name="judul_lagu" 
                           value="{{ old('judul_lagu', $nyanyian->judul_lagu) }}" 
            ...
            <div class="box" style="margin-bottom:20px;">
                ...
                <div class="mb-2">
                    ...
                    <textarea name="lirik" 
                              ...
                              style="width:100%;max-height:400px;padding:12px;border:1px solid #e0e6f1;border-radius:6px;font-family:monospace;line-height:1.6;resize:vertical;overflow-y:auto;">{{ old('lirik', $nyanyian->lirik) }}</textarea>
                ...
                <div class="mb-2">
                    ...
                    <div style="display:flex;gap:16px;">
                        <label style="display:flex;align-items:center;gap:6px;cursor:pointer;">
                            <input type="radio" name="status" value="1" {{ old('status', $nyanyian->status) == '1' ? 'checked' : '' }} required>
                            <span><i class="fas fa-check-circle" style="color:#28a745;"></i> Aktif (Tampil di halaman publik)</span>
                        </label>
                        <label style="display:flex;align-items:center;gap:6px;cursor:pointer;">
                            <input type="radio" name="status" value="0" {{ old('status', $nyanyian->status) == '0' ? 'checked' : '' }}>
            ...
            <div style="display:flex;gap:12px;justify-content:flex-end;margin-top:24px;margin-bottom:40px;">
                ...
                <button class="action-button" type="submit" style="background:#ffc107;color:#000;">
